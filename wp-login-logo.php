                ...
                <div class="meta-box-sortables ui-sortable" id="normal-sortables"><div class="postbox " id="dashboard_right_now">
                    <div title="Click to toggle" class="handlediv"><br></div>
                        ...
                        <div class="inside">
                            ...
                            <a style="float: right;" href="#TB_inline?width=500&height=510&inlineId=check-preview" class="button-primary thickbox"><?php _e("Check Preview", "WebritiCustomLoginTD"); ?></a>
                            <table>
                                <tbody>
                                    <tr>
